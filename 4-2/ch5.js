...
const C='#e11d48';
const slides=[{"sec":"5-1","name":"一位小數乘以整數","title":"一位小數乘以整數","points":["<span class=\"k\">一位小數乘整數，先當整數乘再點回一位小數</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"2.4×6","ans":"14.4","variant":0},{"sec":"5-2","name":"二位小數乘以整數","title":"二位小數乘以整數","points":["<span class=\"k\">二位小數乘整數，積要保留正確小數位數</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"1.25×8","ans":"10","variant":0},{"sec":"5-3","name":"小數計算的應用","title":"小數計算的應用","points":["<span class=\"k\">先依情境列小數乘法，再估算檢查合理性</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"每公尺3.6元，買5公尺多少元？","ans":"18元","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M42Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:5,title:"小數乘法",color:C,sections:["5-1 一位小數乘以整數","5-2 二位小數乘以整數","5-3 小數計算的應用"],slides});})();
