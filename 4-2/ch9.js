/* 第9章 時間的計算；範圍：時間換算、加減與兩時刻間隔；不做時間乘除。 */
...
const C='#16a34a';
const slides=[{"sec":"9-1","name":"時間單位的換算","title":"時間單位的換算","points":["<span class=\"k\">1日＝24小時，1小時＝60分，1分＝60秒</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"2小時30分是多少分？","ans":"150分","variant":0},{"sec":"9-2","name":"時間量的加減","title":"時間量的加減","points":["<span class=\"k\">時間量加減要同單位對齊，滿60要進位或借位</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"2小時45分＋1小時30分","ans":"4小時15分","variant":0},{"sec":"9-3","name":"兩時刻間的時間量","title":"兩時刻間的時間量","points":["<span class=\"k\">可用終止時刻減開始時刻，跨整點時分段計算</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"9時35分到11時10分經過多久？","ans":"1小時35分","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M42Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:9,title:"時間的計算",color:C,sections:["9-1 時間單位的換算","9-2 時間量的加減","9-3 兩時刻間的時間量"],slides});})();
