/* 第10章 立方公分；範圍：以堆疊與1立方公分認識體積；不教體積公式。 */
...
const C='#0f766e';
const slides=[{"sec":"10-1","name":"認識體積","title":"認識體積","points":["<span class=\"k\">物體所占空間的大小叫體積</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"兩物體外形不同，能只看高度比體積嗎？","ans":"不能","variant":0},{"sec":"10-2","name":"立體堆疊","title":"立體堆疊","points":["<span class=\"k\">看不到的積木也要依上下、前後關係算入</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"底層6顆、上層2顆，共幾顆？","ans":"8顆","variant":0},{"sec":"10-3","name":"認識立方公分","title":"認識立方公分","points":["<span class=\"k\">邊長1公分的正方體，體積是1立方公分</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"用邊長1公分的正方體排成每層6個、共2層，體積？","ans":"12立方公分","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M42Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:10,title:"立方公分",color:C,sections:["10-1 認識體積","10-2 立體堆疊","10-3 認識立方公分"],slides});})();
