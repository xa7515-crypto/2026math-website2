/* 第1章 多位數的乘與除；範圍：三四位數乘三位數、末位0乘法及除三位數。 */
...
const C='#2563eb';
const slides=[{"sec":"1-1","name":"三、四位數乘以三位數","title":"三、四位數乘以三位數","points":["<span class=\"k\">乘三位數要依個、十、百位分列部分積並對齊</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"1234×205","ans":"252970","variant":0},{"sec":"1-2","name":"末幾位為0的乘法","title":"末幾位為0的乘法","points":["<span class=\"k\">末尾有0可先算非0部分，再補回省略的0</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"2400×300","ans":"720000","variant":0},{"sec":"1-3","name":"三、四位數除以三位數","title":"三、四位數除以三位數","points":["<span class=\"k\">除以三位數先估商，再乘、減、落下</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"2460÷120","ans":"20餘60","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M42Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:1,title:"多位數的乘與除",color:C,sections:["1-1 三、四位數乘以三位數","1-2 末幾位為0的乘法","1-3 三、四位數除以三位數"],slides});})();
