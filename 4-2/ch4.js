...
const C='#d97706';
const slides=[{"sec":"4-1","name":"圖形的規律","title":"圖形的規律","points":["<span class=\"k\">觀察圖形每次增加、減少或重複的方式</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"●■▲●■▲下一個是？","ans":"●","variant":0},{"sec":"4-2","name":"數字的規律","title":"數字的規律","points":["<span class=\"k\">先比較相鄰數的差或倍數，找出數列規律</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"3、6、9、12，下一個？","ans":"15","variant":0},{"sec":"4-3","name":"奇偶數的規律","title":"奇偶數的規律","points":["<span class=\"k\">偶數加偶數是偶數，奇數加奇數也是偶數</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"7＋9是奇數還是偶數？","ans":"偶數","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M42Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:4,title:"數量規律",color:C,sections:["4-1 圖形的規律","4-2 數字的規律","4-3 奇偶數的規律"],slides});})();
