...
const C='#0891b2';
const slides=[{"sec":"6-1","name":"長方形、正方形的周長","title":"長方形、正方形的周長","points":["<span class=\"k\">長方形周長＝(長＋寬)×2，正方形＝邊長×4</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"長8、寬5的長方形周長？","ans":"26公分","variant":0},{"sec":"6-2","name":"長方形、正方形的面積","title":"長方形、正方形的面積","points":["<span class=\"k\">長方形面積＝長×寬，正方形＝邊長×邊長</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"長8、寬5的長方形面積？","ans":"40平方公分","variant":0},{"sec":"6-3","name":"周長和面積的關係","title":"周長和面積的關係","points":["<span class=\"k\">周長相同面積不一定相同，面積相同周長也不一定相同</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"周長都是20的長方形，面積都相同嗎？","ans":"不一定","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M42Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:6,title:"周長與面積",color:C,sections:["6-1 長方形、正方形的周長","6-2 長方形、正方形的面積","6-3 周長和面積的關係"],slides});})();
