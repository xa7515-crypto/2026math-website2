/* 第3章 概數；範圍：生活概數、無條件進入與捨去；四捨五入另冊處理。 */
...
const C='#059669';
const slides=[{"sec":"3-1","name":"生活中的概數","title":"生活中的概數","points":["<span class=\"k\">概數是接近實際數、便於表達或計算的數</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"全校約1200人中的「約」表示什麼？","ans":"1200是概數","variant":0},{"sec":"3-2","name":"無條件進入法","title":"無條件進入法","points":["<span class=\"k\">無條件進入法只要後面有數就往前進1</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"321人每車載40人，需要幾車？","ans":"9車","variant":0},{"sec":"3-3","name":"無條件捨去法","title":"無條件捨去法","points":["<span class=\"k\">無條件捨去法直接捨去指定數位後面的數</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"895元最多能買每個200元的物品幾個？","ans":"4個","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M42Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:3,title:"概數",color:C,sections:["3-1 生活中的概數","3-2 無條件進入法","3-3 無條件捨去法"],slides});})();
