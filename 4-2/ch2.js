/* 第2章 四邊形；範圍：垂直平行、四邊形分類與作圖；不計算面積。 */
...
const C='#7c3aed';
const slides=[{"sec":"2-1","name":"垂直和平行","title":"垂直和平行","points":["<span class=\"k\">兩直線相交成直角叫垂直，永不相交叫平行</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"十字路口兩條道路成90°，關係？","ans":"互相垂直","variant":0},{"sec":"2-2","name":"認識各類四邊形","title":"認識各類四邊形","points":["<span class=\"k\">依邊長與平行關係辨認正方形、長方形、平行四邊形和梯形</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"只有一組對邊平行的四邊形？","ans":"梯形","variant":0},{"sec":"2-3","name":"分割四邊形及畫四邊形","title":"分割四邊形及畫四邊形","points":["<span class=\"k\">可用三角板的直角與平行邊畫指定四邊形</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"畫長方形要確認哪些條件？","ans":"四個直角、對邊等長","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M42Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:2,title:"四邊形",color:C,sections:["2-1 垂直和平行","2-2 認識各類四邊形","2-3 分割四邊形及畫四邊形"],slides});})();
