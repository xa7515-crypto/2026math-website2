...
const C='#2563eb';
const slides=[{"sec":"1-1","name":"十萬以內的數","title":"十萬以內的數","points":["<span class=\"k\">從個、十、百、千、萬位認讀十萬以內的數</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"五萬零六十寫成數字","ans":"50060","variant":0},{"sec":"1-2","name":"一億以內的數","title":"一億以內的數","points":["<span class=\"k\">四位一級，從個級、萬級讀一億以內的數</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"三千零五萬零八寫成數字","ans":"30050008","variant":0},{"sec":"1-3","name":"數的大小比較","title":"數的大小比較","points":["<span class=\"k\">位數不同先比位數，位數相同從最高位比</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"比較45,090,000和45,900,000","ans":"45,090,000＜45,900,000","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M41Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:1,title:"一億以內的數",color:C,sections:["1-1 十萬以內的數","1-2 一億以內的數","1-3 數的大小比較"],slides});})();
