/* 第8章 整數四則計算；範圍：整數兩步驟併式；不引入運算律符號化。 */
...
const C='#ea580c';
const slides=[{"sec":"8-1","name":"加減兩步驟的併式","title":"加減兩步驟的併式","points":["<span class=\"k\">依題意把兩個加減算式合併，括號內先算</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"500－120＋80","ans":"460","variant":0},{"sec":"8-2","name":"乘除兩步驟的併式","title":"乘除兩步驟的併式","points":["<span class=\"k\">乘除同級運算依題意由左往右</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"240÷6×5","ans":"200","variant":0},{"sec":"8-3","name":"加減與乘的併式","title":"加減與乘的併式","points":["<span class=\"k\">沒有括號先乘法，再做加減法</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"100－8×7","ans":"44","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M41Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:8,title:"整數四則計算",color:C,sections:["8-1 加減兩步驟的併式","8-2 乘除兩步驟的併式","8-3 加減與乘的併式"],slides});})();
