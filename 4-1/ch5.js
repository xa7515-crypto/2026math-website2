...
const C='#e11d48';
const slides=[{"sec":"5-1","name":"認識公里","title":"認識公里","points":["<span class=\"k\">較長距離常用公里，1公里＝1000公尺</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"學校到車站約3什麼？","ans":"3公里","variant":0},{"sec":"5-2","name":"公里、公尺和公分的換算","title":"公里、公尺和公分的換算","points":["<span class=\"k\">公里、公尺、公分換算要依1000或100進位</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"2公里350公尺是多少公尺？","ans":"2350公尺","variant":0},{"sec":"5-3","name":"公里和公尺的加減計算","title":"公里和公尺的加減計算","points":["<span class=\"k\">加減前先把公里與公尺分別對齊</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"3公里200公尺＋1公里850公尺","ans":"5公里50公尺","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M41Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:5,title:"公里",color:C,sections:["5-1 認識公里","5-2 公里、公尺和公分的換算","5-3 公里和公尺的加減計算"],slides});})();
