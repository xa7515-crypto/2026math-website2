...
const C='#d97706';
const slides=[{"sec":"4-1","name":"四位數除以一位數","title":"四位數除以一位數","points":["<span class=\"k\">從最高位開始除，每次餘數要小於除數</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"4824÷6","ans":"804","variant":0},{"sec":"4-2","name":"二位數除以二位數","title":"二位數除以二位數","points":["<span class=\"k\">用估商找商的十位與個位，乘回去不能超過被除數</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"84÷21","ans":"4","variant":0},{"sec":"4-3","name":"三位數除以二位數","title":"三位數除以二位數","points":["<span class=\"k\">先用除數前幾位估商，再乘、減、落下</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"936÷24","ans":"39","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M41Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:4,title:"整數的除法",color:C,sections:["4-1 四位數除以一位數","4-2 二位數除以二位數","4-3 三位數除以二位數"],slides});})();
