...
const C='#059669';
const slides=[{"sec":"3-1","name":"量角器的認識與報讀","title":"量角器的認識與報讀","points":["<span class=\"k\">量角器中心對準頂點，0度線對準一邊</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"量角器內外圈要怎麼選？","ans":"從0度所在那圈開始讀","variant":0},{"sec":"3-2","name":"測量角的大小和畫角","title":"測量角的大小和畫角","points":["<span class=\"k\">先對準頂點與0度線，再讀或標出角度</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"畫一個60°的角","ans":"從0°量到60°畫第二邊","variant":0},{"sec":"3-3","name":"旋轉角","title":"旋轉角","points":["<span class=\"k\">一周角360°、平角180°、直角90°</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"轉四分之三圈是多少度？","ans":"270°","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M41Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:3,title:"角度",color:C,sections:["3-1 量角器的認識與報讀","3-2 測量角的大小和畫角","3-3 旋轉角"],slides});})();
