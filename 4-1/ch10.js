/* 第10章 統計圖；範圍：生活統計圖、長條圖和折線圖；不計算平均數。 */
...
const C='#0f766e';
const slides=[{"sec":"10-1","name":"報讀生活中的統計圖","title":"報讀生活中的統計圖","points":["<span class=\"k\">先看圖名、圖例、單位與資料來源再讀數</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"圖例每個圖案代表5人，3個圖案是多少人？","ans":"15人","variant":0},{"sec":"10-2","name":"報讀與繪製長條圖","title":"報讀與繪製長條圖","points":["<span class=\"k\">長條高度對應數量，刻度不一定每格是1</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"每格代表10，長條高6格是多少？","ans":"60","variant":0},{"sec":"10-3","name":"報讀折線圖","title":"報讀折線圖","points":["<span class=\"k\">折線圖用點與線表示數量隨順序的變化</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"折線從20升到35，增加多少？","ans":"15","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M41Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:10,title:"統計圖",color:C,sections:["10-1 報讀生活中的統計圖","10-2 報讀與繪製長條圖","10-3 報讀折線圖"],slides});})();
