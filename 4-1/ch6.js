...
const C='#0891b2';
const slides=[{"sec":"6-1","name":"三角形","title":"三角形","points":["<span class=\"k\">三條線段首尾相接可圍成三角形</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"三角形有幾條邊、幾個角？","ans":"3條邊、3個角","variant":0},{"sec":"6-2","name":"以邊分類三角形","title":"以邊分類三角形","points":["<span class=\"k\">三邊相等是正三角形，兩邊相等是等腰三角形</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"邊長5、5、8是哪種三角形？","ans":"等腰三角形","variant":0},{"sec":"6-3","name":"以角分類三角形","title":"以角分類三角形","points":["<span class=\"k\">有直角是直角三角形，有鈍角是鈍角三角形，其餘是銳角三角形</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"有一個120°角是哪種三角形？","ans":"鈍角三角形","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M41Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:6,title:"三角形",color:C,sections:["6-1 三角形","6-2 以邊分類三角形","6-3 以角分類三角形"],slides});})();
