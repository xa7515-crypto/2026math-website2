...
const C='#9333ea';
const slides=[{"sec":"7-1","name":"認識二位小數","title":"認識二位小數","points":["<span class=\"k\">0.01是百分之一，二位小數到百分位</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"3個一、4個十分之一、7個百分之一","ans":"3.47","variant":0},{"sec":"7-2","name":"長度與小數的大小比較","title":"長度與小數的大小比較","points":["<span class=\"k\">比較小數要對齊小數點，末尾補0不改變大小</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"比較2.5和2.48","ans":"2.50＞2.48","variant":0},{"sec":"7-3","name":"小數的加減","title":"小數的加減","points":["<span class=\"k\">小數加減直式要把小數點對齊</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"3.75＋2.8","ans":"6.55","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M41Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:7,title:"小數",color:C,sections:["7-1 認識二位小數","7-2 長度與小數的大小比較","7-3 小數的加減"],slides});})();
