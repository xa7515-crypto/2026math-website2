...
const C='#7c3aed';
const slides=[{"sec":"2-1","name":"四位數乘以一位數","title":"四位數乘以一位數","points":["<span class=\"k\">多位數乘一位數要逐位相乘並處理進位</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"2345×3","ans":"7035","variant":0},{"sec":"2-2","name":"一、二位數乘以二位數","title":"一、二位數乘以二位數","points":["<span class=\"k\">乘二位數時，第二列積要向左移一位</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"36×24","ans":"864","variant":0},{"sec":"2-3","name":"三、四位數乘以二位數","title":"三、四位數乘以二位數","points":["<span class=\"k\">先估算積的位數，再用直式逐位計算</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"1205×32","ans":"38560","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M41Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:2,title:"整數的乘法",color:C,sections:["2-1 四位數乘以一位數","2-2 一、二位數乘以二位數","2-3 三、四位數乘以二位數"],slides});})();
