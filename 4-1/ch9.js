...
const C='#16a34a';
const slides=[{"sec":"9-1","name":"認識真分數、假分數和帶分數","title":"認識真分數、假分數和帶分數","points":["<span class=\"k\">分子小於分母是真分數，大於等於分母是假分數</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"\\(\\dfrac{7}{5}\\)是哪一類分數？","ans":"假分數","variant":0},{"sec":"9-2","name":"假分數和帶分數的互換與比大小","title":"假分數和帶分數的互換與比大小","points":["<span class=\"k\">假分數除出整數與餘數可換帶分數</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"\\(\\dfrac{11}{4}\\)換成帶分數","ans":"\\(2\\dfrac{3}{4}\\)","variant":0},{"sec":"9-3","name":"同分母分數的加減","title":"同分母分數的加減","points":["<span class=\"k\">同分母分數只把分子相加減，分母不變</span>。","拖曳「切換實例」，比較三個教材情境。","用圖形、算式和完整單位一起核對。"],"q":"\\(\\dfrac{3}{8}\\)＋\\(\\dfrac{2}{8}\\)","ans":"\\(\\dfrac{5}{8}\\)","variant":0}].map(o=>({sec:o.sec,secName:o.name,title:o.title,points:o.points,formula:null,visual:h=>window.M41Activity.render(h,o.sec,o.variant),caption:'小節名稱對應一個互動頁；拖曳切換實例，圖形、教材式算式與答案同步更新。',example:{q:o.q,steps:['先讀懂情境並預測','拖曳切換三個實際例子','用圖形、算式和單位核對'],ans:o.ans}}));
window.DECK.push({ch:9,title:"分數",color:C,sections:["9-1 認識真分數、假分數和帶分數","9-2 假分數和帶分數的互換與比大小","9-3 同分母分數的加減"],slides});})();
